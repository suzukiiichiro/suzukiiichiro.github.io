...
[前回（簡単にできるHugoで人気の記事を表示する方法 #01）](/posts/2022-01-06-wyoshi/)ではGAS（Google App Scripts）を使ってアナリティクスのデータをスプレッドシートに反映するところまで説明しました。
...
前回作成したプログラムを開きます。
開き方は前回の「[簡単にできるHugoで人気の記事を表示する方法 #01](/posts/2022-01-06-wyoshi/)」にある「スプレッドシートの設定」を確認してください。
