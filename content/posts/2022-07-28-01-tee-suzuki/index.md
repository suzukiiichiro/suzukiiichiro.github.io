---
title: "（２６）【tee】シェルスクリプトコマンド活用紹介"
description: "標準出力とファイルの両方に出力する"
date: 2022-07-28T10:24:32+09:00
draft: false
...
|オプション    |意味|
|--------------|----|
|-a|指定したファイルが既に存在する場合、上書きせずに追加する（リダイレクトの「>>」に相当）|
