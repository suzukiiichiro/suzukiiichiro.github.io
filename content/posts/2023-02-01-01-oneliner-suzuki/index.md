...
　じっくりやれば時間もかかりますが、Linuxで生きていくなら知っていて損にはならないページであると思っています。

　書いてあることを暗記する必要はありません。
　書いてあったことを覚えておけばよいです。必要であればこのページを開いて探せばよいのです。

　シェルスクリプトでプログラムを書くことで、ちまたや本にはなかなか書かれていないTIPSもいくつか紹介します。
...
　ページ後半には、僕が感銘を受けた名著も紹介しています。UNIXという考え方をしっかり意味のある言葉で説明してくれるとても素晴らしい名著です。

　ページ後半には、自作コマンドを数本紹介しています。すべてシェルスクリプトで作ってありますので、改造してより良いコマンドに仕上げてもらえれば嬉しいです。

　

grepやawk、sedコマンドでできることは無限です。
すべてを覚えてしまおうというのはどだい無理なのです。
まずは、このページのコマンドを順番に実行して、感覚を身につけましょう。
浅く何度も繰り返し反復することで、直感的に理解できます。


ちなみに１０００本というのは勢い余っていっていますがだいたい７００本です。
