---
title: "【comm】bash/シェルスクリプトマニアックコマンドあれこれ１０"
date: 2022-11-08T17:38:59+09:00
draft: false
authors: suzuki
image: bash.jpg
categories:
...
インデントで３つの区分が見えますね。
１つ目のインデント列は、１列目にだけあるもの、
２つ目のインデント列は、２列めだけにあるもの、
３つ目のインデント列は、両方にあるもの
